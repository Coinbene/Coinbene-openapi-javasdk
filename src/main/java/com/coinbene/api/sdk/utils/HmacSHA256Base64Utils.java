...
import com.coinbene.api.sdk.enums.AlgorithmEnum;
import com.coinbene.api.sdk.enums.CharsetEnum;
...
public class HmacSHA256Base64Utils {
    ...
    public static String sign1(String timestamp, String method, String requestPath,
                              String queryString, String body, String secretKey)
            throws Exception {
        if (StringUtils.isEmpty(secretKey) || StringUtils.isEmpty(method)) {
            return APIConstants.EMPTY;
