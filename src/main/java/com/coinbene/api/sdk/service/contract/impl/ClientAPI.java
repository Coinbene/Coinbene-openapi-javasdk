...
public interface ClientAPI {
     ...
     * @return
     */
    @GET("/api/swap/v2/account/contract/list")
     ...
     * @return
     */
    @GET("/api/swap/v2/position/feeRate")
     ...
     * @return
     */
    @GET("/api/swap/v2/market/tickers")
     ...
     * @return
     */
    @POST("/api/swap/v2/order/batchCancel")
     ...
     * @return
     */
    @GET("/api/swap/v2/order/openOrders")
     ...
     * @return
     */
    @GET("/api/swap/v2/order/closedOrders")
    ...
    @GET("/api/swap/v2/order/openOrdersByPage")
    Call<ApiResponse> openOrders(@Query("symbol") final String symbol,
                                 @Query("latestOrderId") final String latestOrderId);


    @GET("/api/swap/v2/order/closedOrdersByPage")
